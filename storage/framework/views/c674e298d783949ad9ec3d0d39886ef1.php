        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
                <p class="small text-muted">
                    <?php echo app('translator')->get('pagination.showing'); ?>
                    <span class="fw-semibold"><?php echo e($paginator->firstItem()); ?></span>
                    <?php echo app('translator')->get('pagination.to'); ?>
                    <span class="fw-semibold"><?php echo e($paginator->lastItem()); ?></span>
                    <?php echo app('translator')->get('pagination.of'); ?>
                    <span class="fw-semibold"><?php echo e($paginator->total()); ?></span>
                    <?php echo app('translator')->get('pagination.results'); ?>
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\user\OneDrive\Desktop\course-review-app\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>